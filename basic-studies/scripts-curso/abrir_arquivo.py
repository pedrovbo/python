...
arquivo2 = open("/home/pedrovbo/GitHub/repositorios/python/python-projects/basic-studies/scripts-curso/dados1.txt")  # Caminho absoluto

# Para o arquivo dados2.txt
arquivo3 = open("documentos/dados2.txt")  # Caminho relativo
arquivo4 = open("/home/pedrovbo/GitHub/repositorios/python/python-projects/basic-studies/scripts-curso/documentos/dados2.txt")  # Caminho absoluto
